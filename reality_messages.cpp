                     ...
                     const ExtensionBuildContext& ctx)
{
    switch (ext_ptr->type())
    {
        case ExtensionType::kGrease:
            return build_grease_ext(ext_buffer, ext_type, ctx);
        case ExtensionType::kSni:
