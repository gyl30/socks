...
// Test HKDF (RFC 5869 Test Vector 1)
TEST(CryptoUtilTest, HKDF_RFC5869_Test1) {
    ...
    // RFC 5869 Test Case 1 PRK output
    ...
    // RFC 5869 Test Case 1 OKM output
...
TEST(CryptoUtilTest, AEAD_AES_GCM_RoundTrip) {
    std::vector<uint8_t> key(32, 0x11); // 256-bit key
    std::vector<uint8_t> nonce(12, 0x22); // 96-bit nonce
    ...
    // Basic size check: Ciphertext = Plaintext + Tag (16 bytes)
