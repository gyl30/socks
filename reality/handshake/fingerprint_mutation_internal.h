...
{
   public:
    static void set_client_version(fingerprint_template& spec, uint16_t client_version) { spec.client_version_ = client_version; }
    ...
    static void set_shuffle_extensions(fingerprint_template& spec, bool enabled) { spec.shuffle_extensions_ = enabled; }
};
